          ...
          data: (trashed) {
            if (trashed.isEmpty) {
              return const EmptyState(
                ...
                subtitle:
                    'Deleted goals will appear here until you restore or remove them.',
              );
            }
                  ...
                  trailing: Row(
                    ...
                    children: [
                      IconButton(
                        ...
                        tooltip: 'Restore',
                        onPressed: () =>
                            ref.read(savingsRepositoryProvider).restore(goal),
                      ),
                      IconButton(
                        icon: Icon(
                        ...
                        onPressed: () =>
                            _confirmPermanentDelete(context, ref, goal),
                      ),
                    ],
                  ),
                );
  ...
  Future<void> _confirmPermanentDelete(
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          '"${goal.name}" will be permanently removed. This can\'t be undone.',
        ),
        actions: [
          TextButton(
