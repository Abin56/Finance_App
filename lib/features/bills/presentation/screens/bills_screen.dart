        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () => Navigator.of(
              context,
            ).push(MaterialPageRoute(builder: (_) => const BillsTrashScreen())),
          ),
        ],
      ),
          ...
          data: (bills) {
            if (bills.isEmpty) {
              return EmptyState(
                ...
                title: 'No bills yet',
                subtitle:
                    'Add a recurring or one-time bill to start tracking due dates.',
                action: FilledButton(
                  onPressed: () => BillFormSheet.show(context),
              ...
              itemBuilder: (context, index) {
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          ...
                          style: Theme.of(
                            context,
                          ).textTheme.titleSmall?.copyWith(color: slot.color),
                        ),
                      ],
                    ),
                  );
                ...
                return Padding(
                  ...
                  child: Dismissible(
                    ...
                    confirmDismiss: (_) =>
                        confirmDelete(context, entityName: 'Bill'),
                    ...
                    child: BillTile(
                      ...
                      onTap: () =>
                          context.push('${AppRoutes.bills}/${bill.id}'),
                    ),
                  ),
                );
              },
