        ...
        actions: [
          IconButton(
            ...
            onPressed: () => Navigator.of(context).push(
              MaterialPageRoute(
                builder: (_) => BillPaymentsTrashScreen(billId: billId),
              ),
            ),
          ),
          if (bill != null)
                    ...
                    children: [
                      ...
                      if (sorted.isEmpty)
                        const EmptyState(
                          ...
                          subtitle:
                              'Record a payment to track progress toward this bill.',
                        )
                      else
                        for (final payment in sorted)
                          Padding(
                            ...
                            child: Dismissible(
                              ...
                              confirmDismiss: (_) =>
                                  confirmDelete(context, entityName: 'Payment'),
                              ...
                              onDismissed: (_) => _softDeleteWithUndo(
                                context,
                                ref,
                                occurrenceById,
                                payment,
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(
                'Due ${occurrence.dueDate.fullDate}',
                style: context.textTheme.bodyMedium,
              ),
              PaymentUrgencyBadge(urgency: urgency),
            ],
          ),
