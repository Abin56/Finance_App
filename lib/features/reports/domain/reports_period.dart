...
extension ReportsPeriodX on ReportsPeriod {
  ...
  bool get isMonthGranular =>
      this == ReportsPeriod.thisMonth || this == ReportsPeriod.lastMonth;
  ...
  DateTime reportDateFor(Transaction transaction) =>
  ...
  DateRange rangeFor(DateTime now, {int fiscalYearStartMonth = 1}) {
    switch (this) {
      ...
      case ReportsPeriod.financialYear:
        final fyStartYear = now.month >= fiscalYearStartMonth
            ? now.year
            : now.year - 1;
