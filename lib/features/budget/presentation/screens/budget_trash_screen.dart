          ...
          data: (trashed) {
            if (trashed.isEmpty) {
              return const EmptyState(
                ...
                subtitle:
                    'Deleted budgets will appear here until you restore or remove them.',
              );
            }
            ...
            return ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                final categoryName = budget.categoryId == null
                    ...
                    : categoriesById[budget.categoryId]?.name ??
                          'Category budget';
                return ListTile(
                  ...
                  trailing: Row(
                    ...
                    children: [
                      IconButton(
                        ...
                        tooltip: 'Restore',
                        onPressed: () =>
                            ref.read(budgetRepositoryProvider).restore(budget),
                      ),
                      IconButton(
                        icon: Icon(
                        ...
                        onPressed: () =>
                            _confirmPermanentDelete(context, ref, budget),
                      ),
                    ],
                  ),
                );
  ...
  Future<void> _confirmPermanentDelete(
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'This budget will be permanently removed. This can\'t be undone.',
        ),
        actions: [
          TextButton(
