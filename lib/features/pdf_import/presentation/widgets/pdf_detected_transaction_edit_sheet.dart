...
/// Lets the user correct any field a PDF statement row got wrong before it's
/// imported — a copy of Paste Import's `PasteDetectedTransactionEditSheet`
/// (itself a copy of Smart Import's) wired to [pdfImportControllerProvider]
/// instead, since each session's edit sheet calls its own controller
/// directly and can't be shared as-is.
