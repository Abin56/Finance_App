          ...
          data: (trashed) {
            if (trashed.isEmpty) {
              return const EmptyState(
                ...
                subtitle:
                    'Deleted entries will appear here until you restore or remove them.',
              );
            }
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: person == null
                            ? null
                            : () => ref
                                  .read(ledgerRepositoryProvider(personId))
                                  .restoreEntry(person, entry),
                      ),
                      IconButton(
                        icon: Icon(
                        ...
                        onPressed: () =>
                            _confirmPermanentDelete(context, ref, entry),
                      ),
                    ],
                  ),
                );
