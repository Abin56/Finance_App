...
class AddCardToSharedLimitSheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AddCardToSharedLimitSheet> createState() =>
      _AddCardToSharedLimitSheetState();
}

class _AddCardToSharedLimitSheetState
    extends ConsumerState<AddCardToSharedLimitSheet> {
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                ...
                helperText:
                    'The day each month this card\'s bill is generated (e.g. 17)',
