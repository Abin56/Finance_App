...
final creditCardDeletionRepositoriesProvider =
    Provider<CreditCardDeletionRepositories>((ref) {
      return CreditCardDeletionRepositories(
        accountDeletionRepositories: ref.watch(
          accountDeletionRepositoriesProvider,
        ),
        creditCardRepository: ref.watch(creditCardRepositoryProvider),
        sharedCreditLimitRepository: ref.watch(
          sharedCreditLimitRepositoryProvider,
        ),
        emiRepository: ref.watch(emiRepositoryProvider),
        statementRepositoryFor: (cardId) =>
            ref.watch(statementRepositoryProvider(cardId)),
      );
    });
