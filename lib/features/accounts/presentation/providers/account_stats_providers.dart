...
///
/// Only Income/Expense are populated for now: they're computable directly
/// from [Transaction.type], the same field every other balance/total
/// aggregation in the app already trusts. Credit Card Payments, Bills Paid,
/// Loan/EMI Payments, and Split Expense Payments are deliberately not
/// inferred by matching category names or descriptions — that would be a
/// heuristic, not a reuse of existing business logic. Add them here once
/// `StatementPaymentRepository` / `BillRepository` / the payment-schedule
