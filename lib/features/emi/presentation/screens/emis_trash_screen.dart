          ...
          data: (trashed) {
            if (trashed.isEmpty) {
              return const EmptyState(
                ...
                subtitle:
                    'Archived EMIs will appear here until you restore or remove them.',
              );
            }
            ...
            return ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  title: Text(emi.name),
                  subtitle: Text(
                    'Archived ${emi.deletedAt!.toLocal()}'.split('.').first,
                  ),
                  trailing: Row(
                    ...
                    children: [
                      IconButton(
                        ...
                        tooltip: 'Restore',
                        onPressed: () =>
                            ref.read(emiRepositoryProvider).restore(emi),
                      ),
                      IconButton(
                        icon: Icon(
                        ...
                        onPressed: () =>
                            _confirmPermanentDelete(context, ref, emi),
                      ),
                    ],
                  ),
                );
  ...
  Future<void> _confirmPermanentDelete(
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'This EMI and its payment history will be permanently removed. This can\'t be undone.',
        ),
        actions: [
          TextButton(
