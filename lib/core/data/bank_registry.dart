...
abstract class BankRegistry {
  ...
  static const List<BankInfo> all = [
    ...
    BankInfo(
      ...
      shortCode: 'UBI',
      primaryColor: Color(0xFF1B5FA8),
    ),
    BankInfo(
      id: 'indian_bank',
      name: 'Indian Bank',
      shortCode: 'IB',
      primaryColor: Color(0xFF1FB873),
    ),
    BankInfo(
      id: 'iob',
      name: 'Indian Overseas Bank',
      shortCode: 'IOB',
      primaryColor: Color(0xFF2C5AA0),
    ),
    BankInfo(
      id: 'federal',
      name: 'Federal Bank',
      shortCode: 'FED',
      primaryColor: Color(0xFF0F7B3E),
    ),
    BankInfo(
      id: 'south_indian',
      name: 'South Indian Bank',
      shortCode: 'SIB',
      primaryColor: Color(0xFF14539A),
    ),
    BankInfo(
      id: 'idfc_first',
    ...
    BankInfo(
      ...
      name: 'RBL Bank',
      shortCode: 'RBL',
      primaryColor: Color(0xFF616A6B),
    ),
    BankInfo(
      id: 'bandhan',
      name: 'Bandhan Bank',
      shortCode: 'BDN',
      primaryColor: Color(0xFFAF601A),
    ),
    BankInfo(
      id: 'city_union',
    ...
    BankInfo(
      ...
      name: 'DBS Bank India',
      shortCode: 'DBS',
      primaryColor: Color(0xFFEC1C24),
    ),
    BankInfo(
      id: 'citi',
      name: 'Citi (legacy)',
      shortCode: 'CITI',
      primaryColor: Color(0xFF003A79),
    ),
    BankInfo(
      id: 'boi',
      name: 'Bank of India',
  ...
  static BankInfo? matchByName(String name) {
    ...
    for (final bank in all) {
      if (bank.name.toLowerCase() == normalized ||
          bank.shortCode.toLowerCase() == normalized) {
        return bank;
      }
    }
    for (final bank in all) {
      if (normalized.contains(bank.name.toLowerCase()) ||
