...
void main() {
  ...
  test(
    'loansPayableByPersonProvider finds a loan by payerPersonId, not personId',
    () async {
  ...
  test(
    'loansForPersonProvider and loansPayableByPersonProvider stay independent for a personal loan with no payer link',
    () async {
      final repository = container.read(loanRepositoryProvider);
      await repository.createLoan(
  ...
  test(
    'loanNextUpcomingInstallmentProvider returns the earliest unpaid installment',
    () async {
      final repository = container.read(loanRepositoryProvider);
      ...
      final installments = await container.read(
