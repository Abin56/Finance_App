...
void main() {
  test(
    'raising the credit limit increases available without changing outstanding',
    () {
      ...
      final availableAfter = available(
        creditLimit: 150000,
        outstanding: outstanding,
      );
  ...
  test(
    'lowering the credit limit below outstanding clamps available to 0, never negative',
    () {
  ...
  test(
    'available never exceeds the credit limit even with restored principal',
    () {
      final result = available(
        creditLimit: 100000,
        outstanding: 0,
        principalRestored: 50000,
      );
