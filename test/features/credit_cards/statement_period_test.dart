...
void main() {
  group('StatementPeriodCalculator — the milestone\'s worked example', () {
    test('18 Jun -> 17 Jul cycle, generated 17 Jul, due 5 Aug', () {
      ...
      final period = StatementPeriodCalculator.currentCycleFor(
        card,
    ...
    test(
      'Milestone 14 Task 4 — Next Statement is 18 Jul -> 17 Aug once the current cycle has closed',
      () {
        final card = _card(statementDay: 17, paymentDueDay: 5);
        ...
        final nextStatement = StatementPeriodCalculator.currentCycleFor(
          card,
  ...
  group('StatementPeriodCalculator.mostRecentClosedCycleFor', () {
    test('returns the cycle whose periodEnd has already passed', () {
      ...
      final closed = StatementPeriodCalculator.mostRecentClosedCycleFor(
        card,
