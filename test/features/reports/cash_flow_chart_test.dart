...
void main() {
  ...
  testWidgets(
    'chart total matches the Overview total for plain same-month transactions',
    (tester) async {
      ...
      expect(
        ...
        500,
        reason: 'must equal the Overview card\'s expense total (300+200)',
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      expect(
        ...
        700,
        reason:
            'accounting-month-reassigned transaction must land in a bar, not silently disappear',
      );
    },
  );
