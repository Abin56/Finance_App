...
void main() {
  group('PersonCycleSummary.from', () {
    test(
      'previous-cycle-pending items feed Outstanding/CarryForward/Remaining and their paid sum',
      () {
        ...
        final summary = PersonCycleSummary.from(
          cycleResult: result,
          overallTotals: const PersonOverallTotals(
            totalYouOwe: 0,
            totalTheyOwe: 0,
            netBalance: 0,
          ),
    ...
    test(
      'Overall section passes overallTotals and netBalance through unchanged',
      () {
        final result = CycleEngineResult<PersonTimelineCycleItem>(
          previousCyclePending: const [],
          current: const [],
    ...
    test(
      'an empty cycle result produces all-zero Previous/Current sections',
      () {
        final result = CycleEngineResult<PersonTimelineCycleItem>(
          previousCyclePending: const [],
          current: const [],
