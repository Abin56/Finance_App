...
void main() {
  group('Bill Firestore round-trip', () {
    test(
      'toFirestore/fromFirestore preserves every template field for a recurring bill',
      () async {
    ...
    test(
      'a legacy document with no nextDueDate field falls back to reading dueDate',
      () async {
        final firestore = FakeFirebaseFirestore();
