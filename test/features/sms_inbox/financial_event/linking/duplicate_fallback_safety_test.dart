...
void main() {
  ...
  test(
    '1. successful purchase vs successful duplicate still links as duplicate',
    () async {
      ...
      final result = await engine.evaluate(
        candidate: duplicateNotification,
        id: 'x1',
      );
  ...
  test(
    '6. same merchant + same amount but different transaction meaning must NOT be duplicate',
    () async {
  ...
  test(
    '9. exact reference number still works as the strong linking signal',
    () async {
      final original = buildEvent(
        id: 'o9',
        eventDate: base,
