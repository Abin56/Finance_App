...
void main() {
  group('CycleAnchor.currentCycleFor', () {
    test(
      'now before this month\'s anchor day -> current cycle ends this month',
      () {
    ...
    test(
      'now on the anchor day itself -> that day is the end of the current cycle',
      () {
        const anchor = CycleAnchor(anchorDay: 17);
    ...
    test(
      'now after this month\'s anchor day -> current cycle rolls to next month\'s anchor',
      () {
        const anchor = CycleAnchor(anchorDay: 17);
    ...
    test(
      'anchor day beyond a short month clamps to that month\'s last day',
      () {
  ...
  group('CycleAnchor.classify', () {
    ...
    test('a date inside the current window classifies as current', () {
      expect(
        anchor.classify(DateTime(2026, 7, 20), now: now),
        CycleClassification.current,
      );
    });

    test(
      'a date on the current window\'s start boundary classifies as current',
      () {
        expect(
          anchor.classify(DateTime(2026, 7, 18), now: now),
          CycleClassification.current,
        );
      },
    );
    ...
    test(
      'a date on the current window\'s end boundary classifies as current',
      () {
        expect(
          anchor.classify(DateTime(2026, 8, 17), now: now),
          CycleClassification.current,
        );
      },
    );
    ...
    test(
      'a date before the current window\'s start classifies as previous',
      () {
        expect(
          anchor.classify(DateTime(2026, 7, 17), now: now),
          CycleClassification.previous,
        );
        expect(
          anchor.classify(DateTime(2026, 6, 1), now: now),
          CycleClassification.previous,
        );
      },
    );
    ...
    test('a date after the current window\'s end classifies as future', () {
      expect(
        anchor.classify(DateTime(2026, 8, 18), now: now),
        CycleClassification.future,
      );
    });
