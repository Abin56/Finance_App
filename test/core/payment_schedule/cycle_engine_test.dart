...
void main() {
  ...
  group('CycleEngine.classifyForCarryForward', () {
    ...
    test(
      'a previous-cycle item that opts out via carryForwardEligible=false is dropped even if unsettled',
      () {
        final item = _FakeCycleItem(
          id: 'a',
          cycleDate: DateTime(2026, 7, 1),
    ...
    test('a current-cycle item always shows in current, settled or not', () {
      final unsettled = _FakeCycleItem(
        id: 'a',
        cycleDate: DateTime(2026, 7, 20),
      );
      final settled = _FakeCycleItem(
        id: 'b',
        cycleDate: DateTime(2026, 7, 25),
        isSettled: true,
      );
    ...
    test(
      'a future-cycle item always shows in future, never in current or previousCyclePending',
      () {
